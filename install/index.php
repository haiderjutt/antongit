                ...
                <div class="d-flex flex-column justify-content-center">
                    ...
                    <p class="subheader d-flex flex-row">
                        <span class="text-muted">
							...
							Nulled By <a href="" target="_blank" class="text-gray-500">NJ Team</a>
                        </span>
                    </p>
                </div>
            </div>
                ...
                <section id="setup" style="display: none">
                    ...
                    <form id="setup_form" method="post" action="" role="form">
                        <div class="form-group">
                            ...
                            <small id="license_help" class="form-text text-muted">Nulled By NullJungle So Enter Anything you want</small>
                        </div>
