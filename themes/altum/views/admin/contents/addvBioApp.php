...
<div class="d-flex justify-content-between mb-4">
    <h1 class="h3"><i class="fa fa-fw fa-xs fa-file-alt text-primary-900 mr-2"></i>Add New App
...
<div class="card">
    <div class="card-body">
        ...
        <form action="<?php echo url('admin/pagesections/savenewApp'); ?>" method="post" role="form" enctype="multipart/form-data">
            ...
            <div class="mt-4">
                <input type="submit" name="btnsubmit" value="Save App" class="btn btn-primary">
            </div>
        </form>
