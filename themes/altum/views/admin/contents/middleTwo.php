...
<div class="d-flex justify-content-between mb-4">
    <h1 class="h3"><i class="fa fa-fw fa-xs fa-file-alt text-primary-900 mr-2"></i>Middle Section3(vBio Mini Features)</h1>
    <div class="col-auto">
    ...
    <div class="card-body">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6" style="margin-bottom: 10px; border-bottom: 2px solid;padding-bottom: 10px;">
                   ...
                   <?php }?> 
                      <input type="hidden" name="section_name" value="Middle_Two">
                 ...
                 <div class="col-sm-12 col-md-6" style="margin-bottom: 10px; border-bottom: 2px solid;padding-bottom: 10px;">
                    ...
                    <form  action="<?php echo url('admin/pagesections/sectionTowContents'); ?>" method="post" role="form" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="section_name" value="Middle_Two" class="form-control">
                        </div>
                        <div class="form-group">
            ...
            <div class="row">
             <div class="col-sm-12 col-md-12">
                 ...
                 <table class="table table-custom dataTable no-footer table-bordered table-striped">
                     ...
                     <tbody>
                           <?php while($row = $data->vbio_features->fetch_object()): ?>
                         <tr>
                             <td><?= $row->mf_title; ?> </td> 
                            <td><?= $row->mf_description; ?></td> 
                          <td><?= $row->mf_status==1?"Active":"Not Active"; ?> </td> 
                             <td>
                                 
                                 <a href="<?php echo SITE_URL.'admin/pagesections'.'/editMiddleTwo/'.$row->mf_id; ?>"><i class="fa fa-eye"></i></a> |
                                <a href="<?php echo SITE_URL.'admin/pagesections'.'/deleteMiniF/'.$row->mf_id; ?>"><i class="fa fa-trash"></i></a> 
