                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="active" id="active" class="form-control form-control-sm">
                                ...
                                <option value="0" <?= isset($data->filters->filters['active']) && $data->filters->filters['active'] == '0' ? 'selected="selected"' : null ?>><?= $this->language->admin_users->filters->is_enabled_disabled ?></option>
                                <option value="2" <?= isset($data->filters->filters['active']) && $data->filters->filters['active'] == '2' ? 'selected="selected"' : null ?>><?= $this->language->admin_users->filters->is_enabled_unconfirmed ?></option>
                            </select>
                        </div>
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="results_per_page" id="results_per_page" class="form-control form-control-sm">
                                <option value="25" <?= $data->filters->results_per_page == 25 ? 'selected="selected"' : null ?>>25</option>
                                <option value="50" <?= $data->filters->results_per_page == 50 ? 'selected="selected"' : null ?>>50</option>
                                <option value="100" <?= $data->filters->results_per_page == 100 ? 'selected="selected"' : null ?>>100</option>
                                <option value="250" <?= $data->filters->results_per_page == 250 ? 'selected="selected"' : null ?>>250</option>
                            </select>
                        </div>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex align-items-center">
                        ...
                        <span class="mr-2" data-toggle="tooltip" title="<?= sprintf($this->language->admin_users->table->last_activity, \Altum\Date::get($row->last_activity)) ?>">
